...
## Trajectory gridded frequencies 轨迹网格化频率 {#trajLevel}
...
两条轨迹的欧几里得距离由公式 @eq-Euclid 得出。其中，$X_1$, $Y_1$ 和 $X_2$, $Y_2$ 分别为后向轨迹 $1$ 和 $2$ 的经纬度坐标，$n$ 为后向轨迹的时序数（本例中为96小时）。
